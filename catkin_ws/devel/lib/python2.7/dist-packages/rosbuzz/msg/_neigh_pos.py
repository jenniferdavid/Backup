...
"""autogenerated by genpy from rosbuzz/neigh_pos.msg. Do not edit."""
import sys
...
class neigh_pos(genpy.Message):
  _md5sum = "450833f82a04595d06d2c1f4242fa709"
  _type = "rosbuzz/neigh_pos"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(neigh_pos, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.pos_neigh)
      buff.write(_struct_I.pack(length))
      for val1 in self.pos_neigh:
        _v1 = val1.header
        ...
        buff.write(_struct_B.pack(val1.position_covariance_type))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (val1.position_covariance_type,) = _struct_B.unpack(str[start:end])
        self.pos_neigh.append(val1)
      return self
