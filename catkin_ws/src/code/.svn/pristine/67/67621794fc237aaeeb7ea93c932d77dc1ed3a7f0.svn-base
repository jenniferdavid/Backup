#ifndef at_drive_sim_node_H
#define at_drive_sim_node_H
...
/** \brief Implementation of at inverse kinematics
 *
 ...
 * Therefore it implements inverese kinematics of at, specifically the zero side-slip model. 
...
class AtDriveNode
{
    ...
    protected: 
        ...
        /** \brief Inverse kinematics for the at 
         * 
         * Inverse kinematics for the at. Zero side-slip model
