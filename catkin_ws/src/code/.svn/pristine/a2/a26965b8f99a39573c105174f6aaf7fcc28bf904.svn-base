...
class CHOMP
{
	protected:		
		...
		Vector xinit_;		// initial trajectory (q_1, q_2, ...q_n)		
	...
	public:
		...
		void generateGlobalPath(Vector  &xi);	//optimize path using with numIt_ iterations		
		void generatePathWithSearchRegion(Vector  &xi, Eigen::Matrix4d &Tlocal2global, double &U_cost, double &curv);	//optimize path using with numIt_ iterations with serch region.		
		void generatePathWithCSR(Vector  &xi, double &U_cost, double &curv);	//optimize path using with numIt_ iterations with serch region.		
		...
		double chompUpdateWithSearchRegion(Vector  &xi, Eigen::Matrix4d &Tlocal2global, double &U_cost, double &curv);	//performs a single gradient descent iteration withing predefined search region	
		double chompUpdateWithCSR(Vector  &xi, double &U_cost, double &curv);	//performs a single gradient descent iteration withing predefined search region	
