...
namespace chomp 
{
	void generatePath(Eigen::VectorXd const &qs, Eigen::VectorXd const &qe, Eigen::VectorXd &xi, Eigen::MatrixXd const &obs, double lambda, size_t numIt,double costGain);
	void genPath(Eigen::VectorXd const &qs, Eigen::VectorXd const &qe, Eigen::VectorXd &xi, Eigen::MatrixXd const &obs, double lambda, size_t numIt,double costGain, unsigned int numGoals);
}
#endif // CHOMP_HPP
