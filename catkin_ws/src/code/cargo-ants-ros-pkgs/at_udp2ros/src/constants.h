...
//UPD LIDAR constants
#define LIDAR_THIS_PORT 2001 //2001, 2002
#define LIDAR_COUNT_INIT 0x98 //0x98, 0x4F, starting value of lidar datagram counter
#define NUM_IBEO_LAYERS 8 //8,4
