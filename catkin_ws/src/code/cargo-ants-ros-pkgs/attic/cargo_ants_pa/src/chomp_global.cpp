...
//////////////////////////////////////////////////
// trajectory etc
static size_t  nq;             // number of q stacked into xi
static size_t const cdim(2);            // dimension of config space
static size_t xidim;    // dimension of trajectory, xidim = nq * cdim
...
void genPath(Vector const &qs, Vector const &qe, Vector &xi, Matrix const &obs, double Lambda, size_t numIt, double costGain, unsigned int numGoals)
{
	nq = numGoals;
	xidim = nq *cdim;
